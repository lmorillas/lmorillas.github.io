...
BLOG_AUTHOR = "Luis Miguel"  # (translatable)
BLOG_TITLE = "L\u00edneas para recordar"  # (translatable)
...
BLOG_EMAIL = "morillas@gmail.com"
BLOG_DESCRIPTION = "L\u00edneas para recordar ..."  # (translatable)
